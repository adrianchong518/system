...
vim.keymap.set('n', '<space>te', ':lua require"nvim-tree".toggle(false, true)<cr>', { silent = true })
...
-- Buffer --
vim.keymap.set('n', '<space>bb', '<cmd>lua require("telescope.builtin").buffers()<cr>')
